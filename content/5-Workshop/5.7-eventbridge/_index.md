---
title: "EventBridge and Event-Driven Architecture"
date: 2024-01-01
weight: 7
chapter: false
pre: " <b> 5.7. </b> "
...
Amazon EventBridge is a serverless event bus for building event-driven architectures. In this step, you will:
- Create Custom Event Bus
- Create SQS Queues (Analytics + Notification) with DLQ
...
## Step 2: Create Dead Letter Queues (DLQ)

DLQ stores messages that failed after multiple retries.
...
## Step 3: Create Main SQS Queues with DLQ
...
- **ReceiveMessageWaitTimeSeconds: 20** → Long polling (reduces cost)
...
## Step 4: Grant EventBridge Permission to SQS
...
## Step 6: Configure Lambda SQS Triggers
...
**Note:** Notification has smaller batch size (5) to send emails faster.
...
## Step 9: Python Code Integration
...
**Integrate into attendance service:**
...
Proceed to [Step 8: S3 Data Lake and Athena Analytics](../5.8-analytics) to build data analytics!